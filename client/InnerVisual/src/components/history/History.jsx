  ...
  return (
    <>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3 className='caption-title'>Nos importa tu salud</h3>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3 className='caption-title'>Tratamiento individual</h3>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          <h3 className='caption-title'>Estamos para atenderte</h3>
          <p>
